...
const (
	EchoService_Echo_FullMethodName = "/grpc.fixtures.v1.EchoService/Echo"
)
...
var EchoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.fixtures.v1.EchoService",
	...
	Metadata: "dialectica/example/api/v1alpha1/test.proto",
}
